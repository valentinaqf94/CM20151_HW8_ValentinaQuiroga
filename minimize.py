...
#con los valores de gradiente, se haec uso de la funcion minimize la cual toma los valores del gradiente anteriores
#y calcula otro conjunto de pesos de forma iterativa. Se eligió este metodo porque casi no hay datos pero es poco
#eficiente en terminos de tiempo respecto a otros metodos
# la predicción es una propagacion de los pesos obtenidos

#Disponible en http://www.iro.umontreal.ca/~memisevr/code.html
